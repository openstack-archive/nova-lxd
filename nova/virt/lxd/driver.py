...
class LXDDriver(driver.ComputeDriver):
    ...
    def get_console_output(self, context, instance):
        ...
        def last_bytes(file_like_object, num):
            """copy/paste from old nova/utils.py

            Operation was removed from utils, community suggest create local
            copy in out-of-upstream nova project LXD driver
            """
        ...
        with open(console_path, 'rb') as f:
            log_data, _ = last_bytes(f, MAX_CONSOLE_BYTES)
            return log_data
