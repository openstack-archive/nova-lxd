...
from nova.network import linux_net as linux_net
...
def _get_ovs_config(vif):
    if _is_no_op_firewall() or vif.is_hybrid_plug_enabled():
        return {
...
# TODO(jamespage): deal with hybrid ovs ports and firewalling
